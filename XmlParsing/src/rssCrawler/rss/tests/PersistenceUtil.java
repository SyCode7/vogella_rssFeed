...
public class PersistenceUtil {
    ...
    private EntityManagerFactory getOutsideContainerEM() {
        ...
        properties.put(JDBC_URL, "jdbc:mysql://localhost:3306/standfast");
        properties.put(JDBC_USER, "root");
        properties.put(JDBC_PASSWORD, "tester");
        properties.put(TARGET_SERVER, TargetServer.None);
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("src", properties);
        return emf;
    }
